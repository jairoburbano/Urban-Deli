...
$subpage_title = ' ';
include 'header.php';  ?>
<div class="cuenta cuenta--last estado--resume">
    <div class="sidebar">
        ...
        <nav class="sidebar__nav">
            ...
            <a href="/page-ordenes-pasadas.php" title="Órdenes Pasadas" class="active">Órdenes Pasadas</a>
        </nav><!-- /.sidebar__nav -->
    </div><!-- /.sidebar -->
    <div class="wrap cuenta__content mi__cuenta estado estado--old">
        <!--NOTE: Inicia ITEM-->
        <h1 class="title">Órdenes Pasadas</h1><!-- /.title -->
        <div class="general__container">
            <div class="estado__container">
                <div class="estado__block">
                    ...
                    <div class="estado__item">
                        <div class="estado__box">
                            <button class="accordeon"></button>
                        </div><!-- /.estado__box -->
                    </div><!-- /.estado__item -->
                </div><!-- /.estado__block -->
                <div class="estado__resumen__container">
                ...
                </div><!-- /.estado__resumen__container -->
